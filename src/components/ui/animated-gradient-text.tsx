...
export function AnimatedGradientText({
  ...
  return (
    <div
      className={cn(
        "group relative mx-auto flex max-w-fit flex-row items-center justify-center rounded-2xl bg-white/40 px-8 py-1.5 text-sm font-medium shadow-lg hover:shadow-xl transition-all duration-300 backdrop-blur-sm [--bg-size:300%] hover:scale-[1.02]",
        className,
      )}
    >
      <div
